  ...
  module Actions
    class RemoveGitTagAction < Action
      ...
      def self.example_code
        [
          'remove_git_tag(tag: "0.0.1") # Delete both local tag and remote tag',
          'remove_git_tag(tag: "0.0.1", remove_local: false) # Only delete remote tag',
          'remove_git_tag(tag: "0.0.1", remove_remote: false) # Only delete local tag'
        ]
      end
